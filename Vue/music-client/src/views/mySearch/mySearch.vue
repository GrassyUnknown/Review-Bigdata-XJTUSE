<template>
  ...
  <el-table :data="tableData">
    <el-table-column prop="businessId" label="商户ID"></el-table-column>
...
export default {
  ...
  methods: {
    handleSearch() {
      this.tableData = [{businessId: 1,ii:"ii", address: "北京市海淀区", stars: 5}, {businessId: 2,ii:"ii", address: "北京区", stars: 5}];
      alert(this.tableData.values());
      this.loadData();
    },
    async loadData() {
      try {
